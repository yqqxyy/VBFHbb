...
void TriggerInfo::setRequireThreshold(bool require) {
  m_requireThreshold = require;
}
...
bool TriggerInfo::requiresThreshold() {
  return m_requireThreshold;
}
