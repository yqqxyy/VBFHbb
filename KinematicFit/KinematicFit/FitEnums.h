 ...
 */
namespace AnalysisType {
enum Analysis { UNDEF, VVBB, LVBB, LLBB };
}  // namespace AnalysisType
 ...
 */
namespace MuonType {
enum Detector { Unknown, CB, ID, SA, Calo };
}  // namespace MuonType
 ...
 */
namespace ParameterType {
enum Parameter { Unknown, Eta, Phi, Energy, Pt };
}  // namespace ParameterType
 ...
 */
namespace FitMode {
enum Mode { Unknown, EtaPhiE, EtaPhi, EtaE, PhiE, Eta, Phi, E };
}
 ...
 */
namespace ConstraintType {
enum Constraint { Unknown, SumPx, SumPy, MET, Vmass, Vwidth, Hmass, Hwidth };
}  // namespace ConstraintType
 ...
 */
namespace Idx {
enum PtEtaPhiE { Pt, Eta, Phi, E };

enum GlobParam { TotLHD, mJJ, mLL, SumPx, SumPy };

enum PrePostFit { Prefit, Postfit };
}  // namespace Idx
