...
class FitProcessor {
 ...
 protected:
   ...
   */
  inline void SetDataDir(std::string dir) { fDatadir = dir; }
   ...
   */
  inline int GetNParticles() const { return int(fFitParticleSet->size()); };
   ...
   * @return RMS value
   */
  double GetJetResponseRMS(ParticleType::Particle ptype, int ptypePos,
 ...
 private:
   ...
   */
  static void FCNLikelihood(int& npar, double* grad, double& fval, double* par,
                            int flag);
   ...
   */
  TH1F* GetJetProbabilityHist(ParticleType::Particle ptype, int ptypePos,
                              double pt, double eta);
   ...
   * @return Probability
   */
  double GetJetProbability(ParticleType::Particle ptype, int ptypePos,
                           double fit_pt, double ini_pt, double ini_eta);
