...
struct LogDef {
  ...
  std::string GetClassName() { return fClassName; }
  TLogLevel GetPrintLevel() { return fPrintLevel; }
};
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~<
...
inline std::string Log::ToString(TLogLevel level) {
  static const char* const buffer[] = {"FATAL",   "ERROR", "WARNING", "INFO",
...
inline std::string Log::GetClassStr(std::string str) {
  ...
  for (int i = 0; i < q; ++i) str = str + std::string(" ");
  return str;
}  //;
