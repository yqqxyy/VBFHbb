...
bool KF::FitManager::Initialize(std::string datadir, std::string year) {
  ...
  // Current default is Moriond2020
  std::string TFFileName = "bjet_tf_190509.root";
  m_doGetSumPxyWidth = 1;

  if (year == "2017") {
    // This was used for EPS2017 and ICHEP2018
    TFFileName = "bjet_tf_160804.root";
    // Always using 9 GeV balance constraint
    m_doGetSumPxyWidth = 0;
  } else if (year == "2018") {
    // We did not use this for ICHEP2018
    TFFileName = "bjet_tf_181118.root";
  } else if (year == "2019b") {
    // This was used for Moriond2020
    TFFileName = "bjet_tf_190509.root";
  } else if (year == "2019c") {
    // First look at c-jet response
    TFFileName = "cjet_tf_190510.root";
  } else if (year == "2021b") {
    // PFlow TFs using easy tree
    TFFileName = "bjet_tf_210301_33-05_no75_D_default.root";
  } else {
    Log(me).Write(ERROR) << "unknown year for kf";
    return false;
  }
