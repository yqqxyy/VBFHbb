...
protected:
  ...
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPflowTight_VarRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsTight_VarRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsTight_FixedRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsLoose_VarRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsLoose_FixedRadIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPLVTightIso;
  CP::MuonEfficiencyScaleFactors * m_muonEfficiencyScaleFactorsPLVLooseIso;
  ...
  CP::IsolationLowPtPLVTool            * m_isoLowPtPLV_tool;
