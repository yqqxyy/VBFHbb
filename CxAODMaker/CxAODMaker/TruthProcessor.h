...
public:
  ...
  // return the truthBpspn collection found on the file
  const std::string getTruthBosonsContainer() { return m_truthBosonsContainer;}
...
protected:
  ...
  std::string m_truthBosonsContainer;
  std::string m_truthTopContainer;

  bool m_doFiducial = false;
