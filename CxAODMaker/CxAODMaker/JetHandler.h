...
public:
  ...
  std::vector<int> getDRSortedIndices(std::vector<const xAOD::TruthParticle*> ghostHads, const xAOD::Jet *jet);
  ...
  static EL::StatusCode setBTagProps(xAOD::Jet * jet);
...
protected:
  ...
  JetCalibrationTool * m_jetCalibration_em;
  ...
  bool m_doFullJER;
  bool m_doGhostVRLinkForSmallRJets;
  bool m_doPFlowFjvtHack;
