...
protected:
  ...
  AsgElectronEfficiencyCorrectionTool  * m_effToolIsoPLVLooseMediumLH;
  AsgElectronEfficiencyCorrectionTool  * m_effToolIsoPLVLooseTightLH;
  AsgElectronEfficiencyCorrectionTool  * m_effToolIsoPLVTightMediumLH;
  AsgElectronEfficiencyCorrectionTool  * m_effToolIsoPLVTightTightLH;
