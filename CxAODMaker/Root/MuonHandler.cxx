...
MuonHandler::MuonHandler(const std::string& name, ConfigStore & config, xAOD::TEvent *event,
  ...
  m_muonEfficiencyScaleFactorsPflowTight_VarRadIso(nullptr),
  m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso(nullptr),
  m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso(nullptr),
  m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso(nullptr),
  m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso(nullptr),
  m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso(nullptr),
  m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso(nullptr),
  m_muonEfficiencyScaleFactorsTight_VarRadIso(nullptr),
  m_muonEfficiencyScaleFactorsTight_FixedRadIso(nullptr),
  m_muonEfficiencyScaleFactorsLoose_VarRadIso(nullptr),
  m_muonEfficiencyScaleFactorsLoose_FixedRadIso(nullptr),
  m_muonEfficiencyScaleFactorsPLVTightIso(nullptr),
  m_muonEfficiencyScaleFactorsPLVLooseIso(nullptr),

  // old isolation WPs before 21.2.111
  ...
  m_triggersToMatch()
{
  ...
  m_config.getif<bool>("usePLVIso",m_usePLVIso);
}
...
MuonHandler::~MuonHandler() {
  ...
  delete m_muonEfficiencyScaleFactorsPflowTight_VarRadIso;
  delete m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso;
  delete m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso;
  delete m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso;
  delete m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso;
  delete m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso;
  delete m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso;
  delete m_muonEfficiencyScaleFactorsTight_VarRadIso;
  delete m_muonEfficiencyScaleFactorsTight_FixedRadIso;
  delete m_muonEfficiencyScaleFactorsLoose_VarRadIso;
  delete m_muonEfficiencyScaleFactorsLoose_FixedRadIso;
  delete m_muonEfficiencyScaleFactorsPLVTightIso;
  delete m_muonEfficiencyScaleFactorsPLVLooseIso;
...
EL::StatusCode MuonHandler::initializeTools() {  
  ...
  //---------------------------------------------------
  m_muonCalibrationPeriodTool = new CP::MuonCalibrationPeriodTool("MuonCalibrationPeriodTool");
  m_muonCalibrationPeriodTool->msg().setLevel( m_msgLevel );
  if(m_doSagittaCorrection){
    TOOL_CHECK("MuonHandler::initializeTools()",
               m_muonCalibrationPeriodTool->setProperty("calibrationMode",CP::MuonCalibrationPeriodTool::CalibMode::correctData));
  } else { 
    TOOL_CHECK("MuonHandler::initializeTools()",
               m_muonCalibrationPeriodTool->setProperty("calibrationMode",CP::MuonCalibrationPeriodTool::CalibMode::additionalMCsys));
  }
  ...
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->setProperty("MuonWP", "PflowLoose_VarRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->initialize());
  m_isoLowPtPLV_tool = new CP::IsolationLowPtPLVTool("LowPtPLVTool");
  TOOL_CHECK("MuonHandler::initializeTools()",m_isoLowPtPLV_tool->initialize());
  //Add all the WP you may want to check in the TAccept output
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("PflowLoose_FixedRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("PflowTight_VarRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("PflowTight_FixedRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("HighPtTrackOnly"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("TightTrackOnly_VarRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("TightTrackOnly_FixedRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("Tight_VarRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("Tight_FixedRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("Loose_VarRad"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("Loose_FixedRad"));
  if(m_usePLVIso) {
    TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("PLVLoose"));
    TOOL_CHECK("MuonHandler::initializeTools()",m_isIso->addMuonWP("PLVTight"));
  }

  // old WPs before 21.2.111
  ...
  //Isolation SF for all WP 21.2.111+

  m_muonEfficiencyScaleFactorsPflowTight_VarRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFPflowTight_VarRadIso");
  m_muonEfficiencyScaleFactorsPflowTight_VarRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowTight_VarRadIso->setProperty("WorkingPoint", "PflowTight_VarRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowTight_VarRadIso->initialize());

  m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFPflowTight_FixedRadIso");
  m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso->setProperty("WorkingPoint", "PflowTight_FixedRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso->initialize());

  m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFPflowLoose_VarRadIso");
  m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso->setProperty("WorkingPoint", "PflowLoose_VarRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso->initialize());

  m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFPflowLoose_FixedRadIso");
  m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso->setProperty("WorkingPoint", "PflowLoose_FixedRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso->initialize());

  m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFHighPtTrackOnlyIso");
  m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso->setProperty("WorkingPoint", "HighPtTrackOnlyIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso->initialize());

  m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFTightTrackOnly_VarRadIso");
  m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso->setProperty("WorkingPoint", "TightTrackOnly_VarRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso->initialize());

  m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFTightTrackOnly_FixedRadIso");
  m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso->setProperty("WorkingPoint", "TightTrackOnly_FixedRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso->initialize());

  m_muonEfficiencyScaleFactorsTight_VarRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFTight_VarRadIso");
  m_muonEfficiencyScaleFactorsTight_VarRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTight_VarRadIso->setProperty("WorkingPoint", "Tight_VarRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTight_VarRadIso->initialize());

  m_muonEfficiencyScaleFactorsTight_FixedRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFTight_FixedRadIso");
  m_muonEfficiencyScaleFactorsTight_FixedRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTight_FixedRadIso->setProperty("WorkingPoint", "Tight_FixedRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsTight_FixedRadIso->initialize());

  m_muonEfficiencyScaleFactorsLoose_VarRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFLoose_VarRadIso");
  m_muonEfficiencyScaleFactorsLoose_VarRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsLoose_VarRadIso->setProperty("WorkingPoint", "Loose_VarRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsLoose_VarRadIso->initialize());

  m_muonEfficiencyScaleFactorsLoose_FixedRadIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationSFLoose_FixedRadIso");
  m_muonEfficiencyScaleFactorsLoose_FixedRadIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsLoose_FixedRadIso->setProperty("WorkingPoint", "Loose_FixedRadIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsLoose_FixedRadIso->initialize());

  m_muonEfficiencyScaleFactorsPLVTightIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationPLVTightIso");
  m_muonEfficiencyScaleFactorsPLVTightIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPLVTightIso->setProperty("WorkingPoint", "PLVTightIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPLVTightIso->initialize());

  m_muonEfficiencyScaleFactorsPLVLooseIso = new CP::MuonEfficiencyScaleFactors("MuonIsolationPLVLooseIso");
  m_muonEfficiencyScaleFactorsPLVLooseIso->msg().setLevel( m_msgLevel );
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPLVLooseIso->setProperty("WorkingPoint", "PLVLooseIso"));
  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsPLVLooseIso->initialize());

  //Isolation SF for all WP before 21.2.111
...
//  TOOL_CHECK("MuonHandler::initializeTools()",m_muonEfficiencyScaleFactorsFCTightTrackOnly_FixedRadIso->initialize());
  ...
  if(m_trigDecTool){
    ...
    if(m_isDAODPHYS){
      m_match_Tool.setTypeAndName("Trig::MatchFromCompositeTool/MatchFromCompositeTool");
    } else {
      m_match_Tool.setTypeAndName("Trig::MatchingTool/MuonMatchingTool");
    }
    TOOL_CHECK("MuonHandler::initializeTools()",m_match_Tool.retrieve());
 }
  ...
  std::unordered_map<std::string, PROP<int>*> triggersToMatch {
      ...
      {"HLT_2mu10", &Props::matchHLT_2mu10},
  ...
  // Isolation WPs 21.2.111+
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPflowTight_VarRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsTight_VarRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsTight_FixedRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsLoose_VarRadIso);
  m_sysToolList.push_back(m_muonEfficiencyScaleFactorsLoose_FixedRadIso);
  if(m_usePLVIso) {
    m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPLVTightIso);
    m_sysToolList.push_back(m_muonEfficiencyScaleFactorsPLVLooseIso);
  }

  // Isolation WPs before 21.2.111
...
bool MuonHandler::passLooseMuon(xAOD::Muon * muon) {
  ...
  Props::passPreSel_noIso.set(muon, passSel);
  return passSel;
}
...
EL::StatusCode MuonHandler::decorateOriginParticle(const xAOD::Muon * muon)
{
  ...
  if ( m_doTrigMatch ) {
    ...
    for (auto& trig : m_triggersToMatch) {
      ...
      if(trigDecorators.count(trig.first)) {
        ...
        std::string TriggerContainerName = "TrigMatch_"+trig_name; 
        int is_matched = 0;
        if(!m_isDAODPHYS || 
           m_event->contains<xAOD::TrigCompositeContainer>(TriggerContainerName)){
  ...
  if(m_usePLVIso) {
    CP_CHECK("MuonHandler::augmentLowPtPLV()",m_isoLowPtPLV_tool->augmentPLV(*muon),m_debug);
  } 
...
EL::StatusCode MuonHandler::decorate(xAOD::Muon * muon) 
{
  ...
  bool accepted = static_cast<bool>(m_muonSelectionToolLoose->accept(*muon));
  xAOD::Muon::Quality muonQuality = m_muonSelectionToolLoose->getQuality(*muon);

  Props::isLoose.set(muon, static_cast<bool>(m_muonSelectionToolLoose->accept(*muon)));
  Props::isMedium.set(muon, static_cast<bool>(m_muonSelectionToolMedium->accept(*muon)));
  Props::isTight.set(muon, static_cast<bool>(m_muonSelectionToolTight->accept(*muon)));
  Props::isHighPt.set(muon, static_cast<bool>(m_muonSelectionToolHighPt->accept(*muon)));
  Props::isLowPtEfficiency.set(muon, static_cast<bool>(m_muonSelectionToolLowPtEfficiency->accept(*muon)));
  Props::isVeryLoose.set(muon, static_cast<bool>(m_muonSelectionToolVeryLoose->accept(*muon)));
  ...
  // SFs for isolation WPs 21.2.111+
  float PflowTight_VarRadIsoSF = 1; 
  float PflowTight_FixedRadIsoSF = 1; 
  float PflowLoose_VarRadIsoSF = 1; 
  float PflowLoose_FixedRadIsoSF = 1; 
  float HighPtTrackOnlyIsoSF = 1; 
  float TightTrackOnly_VarRadIsoSF = 1; 
  float TightTrackOnly_FixedRadIsoSF = 1; 
  float Tight_VarRadIsoSF = 1; 
  float Tight_FixedRadIsoSF = 1; 
  float Loose_VarRadIsoSF = 1; 
  float Loose_FixedRadIsoSF = 1; 
  float PLVTightIsoSF = 1;
  float PLVLooseIsoSF = 1;

  // SFs for isolation WPs before 21.2.111
  ...
  if (isMC) {
    ...
    if(accepted && m_eventInfoHandler.get_RandomRunNumber() != 0) {
      ...
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPflowTight_VarRadIso->getEfficiencyScaleFactor(*muon, PflowTight_VarRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso->getEfficiencyScaleFactor(*muon, PflowTight_FixedRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso->getEfficiencyScaleFactor(*muon, PflowLoose_VarRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso->getEfficiencyScaleFactor(*muon, PflowLoose_FixedRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso->getEfficiencyScaleFactor(*muon, HighPtTrackOnlyIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso->getEfficiencyScaleFactor(*muon, TightTrackOnly_VarRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso->getEfficiencyScaleFactor(*muon, TightTrackOnly_FixedRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsTight_VarRadIso->getEfficiencyScaleFactor(*muon, Tight_VarRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsTight_FixedRadIso->getEfficiencyScaleFactor(*muon, Tight_FixedRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsLoose_VarRadIso->getEfficiencyScaleFactor(*muon, Loose_VarRadIsoSF),m_debug);
      CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsLoose_FixedRadIso->getEfficiencyScaleFactor(*muon, Loose_FixedRadIsoSF),m_debug);
      if(m_usePLVIso) {
        CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPLVTightIso->getEfficiencyScaleFactor(*muon, PLVTightIsoSF),m_debug);
        CP_CHECK("MuonHandler::decorate()",m_muonEfficiencyScaleFactorsPLVLooseIso->getEfficiencyScaleFactor(*muon, PLVLooseIsoSF),m_debug);
      }
  ...
  auto isoAccept =  m_isIso->accept( *muon);
  ...
  Props::isPflowTight_VarRadIso.set(muon, isoAccept.getCutResult("PflowTight_VarRad"));
  Props::isPflowTight_FixedRadIso.set(muon, isoAccept.getCutResult("PflowTight_FixedRad"));
  Props::isPflowLoose_VarRadIso.set(muon, isoAccept.getCutResult("PflowLoose_VarRad"));
  Props::isPflowLoose_FixedRadIso.set(muon, isoAccept.getCutResult("PflowLoose_FixedRad"));
  Props::isHighPtTrackOnlyIso.set(muon, isoAccept.getCutResult("HighPtTrackOnly"));
  Props::isTightTrackOnly_VarRadIso.set(muon, isoAccept.getCutResult("TightTrackOnly_VarRad"));
  Props::isTightTrackOnly_FixedRadIso.set(muon, isoAccept.getCutResult("TightTrackOnly_FixedRad"));
  Props::isTight_VarRadIso.set(muon, isoAccept.getCutResult("Tight_VarRad"));
  Props::isTight_FixedRadIso.set(muon, isoAccept.getCutResult("Tight_FixedRad"));
  Props::isLoose_VarRadIso.set(muon, isoAccept.getCutResult("Loose_VarRad"));
  Props::isLoose_FixedRadIso.set(muon, isoAccept.getCutResult("Loose_FixedRad"));
  if(m_usePLVIso) {
    Props::isPLVTightIso.set(muon, isoAccept.getCutResult("PLVTight"));
    Props::isPLVLooseIso.set(muon, isoAccept.getCutResult("PLVLoose"));
  }

  // old ISO WPs before 21.2.111
  ...
  // Isolation WPs 21.2.111+
  Props::PflowTight_VarRadIsoSF.set(muon, PflowTight_VarRadIsoSF);
  Props::PflowTight_FixedRadIsoSF.set(muon, PflowTight_FixedRadIsoSF);
  Props::PflowLoose_VarRadIsoSF.set(muon, PflowLoose_VarRadIsoSF);
  Props::PflowLoose_FixedRadIsoSF.set(muon, PflowLoose_FixedRadIsoSF);
  Props::HighPtTrackOnlyIsoSF.set(muon, HighPtTrackOnlyIsoSF);
  Props::TightTrackOnly_VarRadIsoSF.set(muon, TightTrackOnly_VarRadIsoSF);
  Props::TightTrackOnly_FixedRadIsoSF.set(muon, TightTrackOnly_FixedRadIsoSF);
  Props::Tight_VarRadIsoSF.set(muon, Tight_VarRadIsoSF);
  Props::Tight_FixedRadIsoSF.set(muon, Tight_FixedRadIsoSF);
  Props::Loose_VarRadIsoSF.set(muon, Loose_VarRadIsoSF);
  Props::Loose_FixedRadIsoSF.set(muon, Loose_FixedRadIsoSF);
  if(m_usePLVIso) {
    Props::PLVTightIsoSF.set(muon, PLVTightIsoSF);
    Props::PLVLooseIsoSF.set(muon, PLVLooseIsoSF);
  }
...
EL::StatusCode MuonHandler::calibrateCopies(xAOD::MuonContainer * particles, const CP::SystematicSet & sysSet) 
{
  ...
  // Isolation WPs 21.2.111+ 
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPflowTight_VarRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPflowTight_FixedRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPflowLoose_VarRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPflowLoose_FixedRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsHighPtTrackOnlyIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsTightTrackOnly_VarRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsTightTrackOnly_FixedRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsTight_VarRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsTight_FixedRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsLoose_VarRadIso->applySystematicVariation(sysSet),m_debug);
  CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsLoose_FixedRadIso->applySystematicVariation(sysSet),m_debug);
  if(m_usePLVIso) {
    CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPLVTightIso->applySystematicVariation(sysSet),m_debug);
    CP_CHECK("MuonHandler::calibrateCopies()",m_muonEfficiencyScaleFactorsPLVLooseIso->applySystematicVariation(sysSet),m_debug);
  }
  ...
  CP_CHECK("MuonHandler::calibrateCopies()", m_muonCalibrationPeriodTool->beginEvent(), m_debug);
...
EL::StatusCode MuonHandler::writeWeightVariations(xAOD::Muon* inMuon, xAOD::Muon* outMuon, const TString& sysName)
{
  ...
  bool isEffVar  = (sysName == "Nominal" || sysName.BeginsWith("MUON_EFF_RECO_"));
  bool isTTVAVar = (sysName == "Nominal" || sysName.BeginsWith("MUON_EFF_TTVA_"));
  bool isIsoVar  = (sysName == "Nominal" || sysName.BeginsWith("MUON_EFF_ISO_"));
  ...
  if (m_eventInfoHandler.get_isMC() && isIsoVar) {
    ...
    // Isolation WPs 21.2.111+
    Props::PflowTight_VarRadIsoSF.copy(inMuon, outMuon);
    Props::PflowTight_FixedRadIsoSF.copy(inMuon, outMuon);
    Props::PflowLoose_VarRadIsoSF.copy(inMuon, outMuon);
    Props::PflowLoose_FixedRadIsoSF.copy(inMuon, outMuon);
    Props::HighPtTrackOnlyIsoSF.copy(inMuon, outMuon);
    Props::TightTrackOnly_VarRadIsoSF.copy(inMuon, outMuon);
    Props::TightTrackOnly_FixedRadIsoSF.copy(inMuon, outMuon);
    Props::Tight_VarRadIsoSF.copy(inMuon, outMuon);
    Props::Tight_FixedRadIsoSF.copy(inMuon, outMuon);
    Props::Loose_VarRadIsoSF.copy(inMuon, outMuon);
    Props::Loose_FixedRadIsoSF.copy(inMuon, outMuon);
    if(m_usePLVIso) {
      Props::PLVTightIsoSF.copy(inMuon, outMuon);
      Props::PLVLooseIsoSF.copy(inMuon, outMuon);
    } 
...
EL::StatusCode MuonHandler::writeNominal(xAOD::Muon* inMuon, xAOD::Muon* outMuon, const TString& /*sysName*/)
{
  ...
  float trackIso8 = -999.;
  inMuon->isolation(trackIso8, xAOD::Iso::ptcone20_TightTTVA_pt1000);
  outMuon->setIsolation(trackIso8, xAOD::Iso::ptcone20_TightTTVA_pt1000);
  ...
  // Isolation WPs 21.2.111+
  Props::isPflowTight_VarRadIso.copy(inMuon, outMuon);
  Props::isPflowTight_FixedRadIso.copy(inMuon, outMuon);
  Props::isPflowLoose_VarRadIso.copy(inMuon, outMuon);
  Props::isPflowLoose_FixedRadIso.copy(inMuon, outMuon);
  Props::isHighPtTrackOnlyIso.copy(inMuon, outMuon);
  Props::isTightTrackOnly_VarRadIso.copy(inMuon, outMuon);
  Props::isTightTrackOnly_FixedRadIso.copy(inMuon, outMuon);
  Props::isTight_VarRadIso.copy(inMuon, outMuon);
  Props::isTight_FixedRadIso.copy(inMuon, outMuon);
  Props::isLoose_VarRadIso.copy(inMuon, outMuon);
  Props::isLoose_FixedRadIso.copy(inMuon, outMuon);
  if(m_usePLVIso) {
    Props::isPLVTightIso.copy(inMuon,outMuon);
    Props::isPLVLooseIso.copy(inMuon,outMuon);
  }
