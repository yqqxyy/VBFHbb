...
ElectronHandler::ElectronHandler(const std::string& name, ConfigStore & config, xAOD::TEvent * event,
  ...
  m_effToolIsoPLVLooseMediumLH(nullptr),
  m_effToolIsoPLVLooseTightLH(nullptr),
  m_effToolIsoPLVTightMediumLH(nullptr),
  m_effToolIsoPLVTightTightLH(nullptr),
...
ElectronHandler::~ElectronHandler() 
{
  ...
  delete m_effToolIsoPLVLooseMediumLH;
  delete m_effToolIsoPLVLooseTightLH;
  delete m_effToolIsoPLVTightMediumLH;
  delete m_effToolIsoPLVTightTightLH;
...
// trigger tool for bbtautau triggers
  ...
  if(m_usePLVIso){
   ...
   // efficiency tool PLVLoose Iso MediumLH
  //-----------------
  m_effToolIsoPLVLooseMediumLH = new AsgElectronEfficiencyCorrectionTool("AsgElectronEfficiencyCorrectionTool_IsoPLVLooseMediumLH");
  m_effToolIsoPLVLooseMediumLH->msg().setLevel( m_msgLevel );
  std::vector< std::string > correctionFileNameListIsoPLVLooseMediumLH;
  correctionFileNameListIsoPLVLooseMediumLH.push_back("ElectronEfficiencyCorrection/2015_2018/rel21.2/Precision_Summer2020_v1/isolation/efficiencySF.Isolation.MediumLHorTightLH_d0z0_v13_isolPLVLoose.root");
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseMediumLH->setProperty("CorrectionFileNameList", correctionFileNameListIsoPLVLooseMediumLH));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseMediumLH->setProperty("ForceDataType", dataType));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseMediumLH->setProperty("CorrelationModel", "TOTAL"));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseMediumLH->initialize());

  // efficiency tool PLVLoose Iso TightLH
  //-----------------
  m_effToolIsoPLVLooseTightLH = new AsgElectronEfficiencyCorrectionTool("AsgElectronEfficiencyCorrectionTool_IsoPLVLooseTightLH");
  m_effToolIsoPLVLooseTightLH->msg().setLevel( m_msgLevel );
  std::vector< std::string > correctionFileNameListIsoPLVLooseTightLH;
  correctionFileNameListIsoPLVLooseTightLH.push_back("ElectronEfficiencyCorrection/2015_2018/rel21.2/Precision_Summer2020_v1/isolation/efficiencySF.Isolation.MediumLHorTightLH_d0z0_v13_isolPLVLoose.root");
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseTightLH->setProperty("CorrectionFileNameList", correctionFileNameListIsoPLVLooseTightLH));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseTightLH->setProperty("ForceDataType", dataType));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseTightLH->setProperty("CorrelationModel", "TOTAL"));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVLooseTightLH->initialize());

   // efficiency tool PLVTight Iso MediumLH
  //-----------------
  m_effToolIsoPLVTightMediumLH = new AsgElectronEfficiencyCorrectionTool("AsgElectronEfficiencyCorrectionTool_IsoPLVTightMediumLH");
  m_effToolIsoPLVTightMediumLH->msg().setLevel( m_msgLevel );
  std::vector< std::string > correctionFileNameListIsoPLVTightMediumLH;
  correctionFileNameListIsoPLVTightMediumLH.push_back("ElectronEfficiencyCorrection/2015_2018/rel21.2/Precision_Summer2020_v1/isolation/efficiencySF.Isolation.MediumLHorTightLH_d0z0_v13_isolPLVTight.root");
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightMediumLH->setProperty("CorrectionFileNameList", correctionFileNameListIsoPLVTightMediumLH));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightMediumLH->setProperty("ForceDataType", dataType));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightMediumLH->setProperty("CorrelationModel", "TOTAL"));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightMediumLH->initialize());

  // efficiency tool PLVTight Iso TightLH
  //-----------------
  m_effToolIsoPLVTightTightLH = new AsgElectronEfficiencyCorrectionTool("AsgElectronEfficiencyCorrectionTool_IsoPLVTightTightLH");
  m_effToolIsoPLVTightTightLH->msg().setLevel( m_msgLevel );
  std::vector< std::string > correctionFileNameListIsoPLVTightTightLH;
  correctionFileNameListIsoPLVTightTightLH.push_back("ElectronEfficiencyCorrection/2015_2018/rel21.2/Precision_Summer2020_v1/isolation/efficiencySF.Isolation.MediumLHorTightLH_d0z0_v13_isolPLVTight.root");
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightTightLH->setProperty("CorrectionFileNameList", correctionFileNameListIsoPLVTightTightLH));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightTightLH->setProperty("ForceDataType", dataType));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightTightLH->setProperty("CorrelationModel", "TOTAL"));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_effToolIsoPLVTightTightLH->initialize());
  ...
  if (m_usePLVIso) {
    TOOL_CHECK("ElectronHandler::initializeTools()",m_isIso->addElectronWP("PLVLoose"));
    TOOL_CHECK("ElectronHandler::initializeTools()",m_isIso->addElectronWP("PLVTight"));
  }
  ...
  TOOL_CHECK("ElectronHandler::initializeTools()", m_isoCorr_tool->setProperty("AFII_corr", m_eventInfoHandler.get_isAFII() ? true : false));
  TOOL_CHECK("ElectronHandler::initializeTools()", m_isoCorr_tool->initialize());
  
  //Isolation Low Pt PLV Tool
  if (m_usePLVIso) {
    m_isoLowPtPLV_tool = new CP::IsolationLowPtPLVTool("LowPtPLVIso");
    TOOL_CHECK("ElectronHandler::initializeTools()", m_isoLowPtPLV_tool->initialize());
  }
  ...
  if (m_usePLVIso) {
    m_sysToolList.push_back(m_effToolIsoPLVLooseMediumLH);
    m_sysToolList.push_back(m_effToolIsoPLVLooseTightLH);
    m_sysToolList.push_back(m_effToolIsoPLVTightMediumLH);
    m_sysToolList.push_back(m_effToolIsoPLVTightTightLH);
  }
  ...
  std::unordered_map<std::string, PROP<int>*> triggersToMatch {
      ...
      {"HLT_e17_lhloose_2e9_lhloose", &Props::matchHLT_e17_lhloose_2e9_lhloose},
      ...
      {"HLT_e17_lhloose_nod0_2e9_lhloose_nod0", &Props::matchHLT_e17_lhloose_nod0_2e9_lhloose_nod0},
      // https://twiki.cern.ch/twiki/bin/view/Atlas/TrigEgammaRecommendedTriggers2017
      // 2018 has the same trigger recommendation as 2017
      ...
      {"HLT_e24_lhvloose_nod0_2e12_lhvloose_nod0_L1EM20VH_3EM10VH", &Props::matchHLT_e24_lhvloose_nod0_2e12_lhvloose_nod0_L1EM20VH_3EM10VH},

      /* Triggers not in the recommendation
...
bool ElectronHandler::passLooseElectron(xAOD::Electron * electron) {
  ...
  Props::passPreSel_noIso.set(electron, passSel);
  return passSel;
}
...
EL::StatusCode ElectronHandler::decorateOriginParticle(const xAOD::Electron * electron)
{
  ...
  int isTightLH = 0;
  if(trackPart){
    isVeryLooseLH = electron->isAvailable<char>("DFCommonElectronsLHVeryLoose") ? static_cast<int>(electron->auxdata<char>("DFCommonElectronsLHVeryLoose")) : static_cast<bool>(m_checkVeryLooseLH->accept(electron));
    
    isLooseNoBLLH = electron -> isAvailable<char>("DFCommonElectronsLHLoose") ? static_cast<int>(electron -> auxdata<char>("DFCommonElectronsLHLoose")) : static_cast<bool>(m_checkLooseNoBLLH->accept(electron));
  
    // LooseLH < MediumLH < TightLH
    isLooseLH = electron -> isAvailable<char>("DFCommonElectronsLHLooseBL") ? static_cast<int>(electron -> auxdata<char>("DFCommonElectronsLHLooseBL")) : static_cast<bool>(m_checkLooseLH->accept(electron));
    if(isLooseLH) {
      isMediumLH = electron -> isAvailable<char>("DFCommonElectronsLHMedium") ? static_cast<int>(electron -> auxdata<char>("DFCommonElectronsLHMedium")) : static_cast<bool>(m_checkMediumLH->accept(electron));
      if(isMediumLH) {
	isTightLH = electron -> isAvailable<char>("DFCommonElectronsLHTight") ? static_cast<int>(electron -> auxdata<char>("DFCommonElectronsLHTight")) : static_cast<bool>(m_checkTightLH->accept(electron));
      }
    }
  }
 ...
 if(m_doTrigMatch){
  ...
  // the low pT PLV value will be fixed in derivations after 21.2.110 (or 21.2.148)
  if (m_usePLVIso) {
    TOOL_CHECK("ElectronHandler::augmentLowPtPLV()", m_isoLowPtPLV_tool->augmentPLV( *electron));
  }
...
EL::StatusCode ElectronHandler::decorate(xAOD::Electron * electron)
{
  ...
  auto isoAccept = m_isIso->accept( *electron);
  ...
  if (m_usePLVIso) {
    Props::isPLVLooseIso.set(electron, isoAccept.getCutResult("PLVLoose"));
    Props::isPLVTightIso.set(electron, isoAccept.getCutResult("PLVTight"));
  }
  ...
  double effSFIsoPLVLooseMediumLH = 1.;
  double effSFIsoPLVLooseTightLH = 1.;
  double effSFIsoPLVTightMediumLH = 1.;
  double effSFIsoPLVTightTightLH = 1.;
  ...
  if (isMC && electron->pt() >= 7000. && fabs(cluster_eta) < 2.47) {//TODO: Check again this safety guard after full-recommendations are out!
	...
	if (m_usePLVIso) {
	  if (m_effToolIsoPLVLooseMediumLH->getEfficiencyScaleFactor(*electron, effSFIsoPLVLooseMediumLH) == CP::CorrectionCode::Error) {
	    Error("ElectronHandler::decorate()", "ElectronEfficiencyCorrection returned CP::CorrectionCode::Error");
	    return EL::StatusCode::FAILURE;
	  }
	  if (m_effToolIsoPLVTightMediumLH->getEfficiencyScaleFactor(*electron, effSFIsoPLVTightMediumLH) == CP::CorrectionCode::Error) {
	    Error("ElectronHandler::decorate()", "ElectronEfficiencyCorrection returned CP::CorrectionCode::Error");
	    return EL::StatusCode::FAILURE;
	  }
	}
	  ...
	  if (m_usePLVIso) {
	    if (m_effToolIsoPLVLooseTightLH->getEfficiencyScaleFactor(*electron, effSFIsoPLVLooseTightLH) == CP::CorrectionCode::Error) {
	      Error("ElectronHandler::decorate()", "ElectronEfficiencyCorrection returned CP::CorrectionCode::Error");
	      return EL::StatusCode::FAILURE;
	    }
	    if (m_effToolIsoPLVTightTightLH->getEfficiencyScaleFactor(*electron, effSFIsoPLVTightTightLH) == CP::CorrectionCode::Error) {
	      Error("ElectronHandler::decorate()", "ElectronEfficiencyCorrection returned CP::CorrectionCode::Error");
	      return EL::StatusCode::FAILURE;
	    }
	  }
  ...
  if (m_usePLVIso) {
    Props::effSFIsoPLVLooseMediumLH.set(electron, effSFIsoPLVLooseMediumLH);
    Props::effSFIsoPLVLooseTightLH.set(electron,  effSFIsoPLVLooseTightLH);
    Props::effSFIsoPLVTightMediumLH.set(electron, effSFIsoPLVTightMediumLH);
    Props::effSFIsoPLVTightTightLH.set(electron,  effSFIsoPLVTightTightLH);
  }
...
EL::StatusCode ElectronHandler::calibrateCopies(xAOD::ElectronContainer * particles, const CP::SystematicSet & sysSet) 
{
  ...
  if (m_usePLVIso) {
    CP_CHECK("ElectronHandler::calibrateCopies()",m_effToolIsoPLVLooseMediumLH->applySystematicVariation(sysSet),m_debug);
    CP_CHECK("ElectronHandler::calibrateCopies()",m_effToolIsoPLVLooseTightLH->applySystematicVariation(sysSet),m_debug);
    CP_CHECK("ElectronHandler::calibrateCopies()",m_effToolIsoPLVTightMediumLH->applySystematicVariation(sysSet),m_debug);
    CP_CHECK("ElectronHandler::calibrateCopies()",m_effToolIsoPLVTightTightLH->applySystematicVariation(sysSet),m_debug);
  }
...
EL::StatusCode ElectronHandler::writeWeightVariations(xAOD::Electron* inElectron, xAOD::Electron* outElectron, const TString& sysName)
{
  ...
  bool isTrigEffVar = (sysName == "Nominal" || sysName.BeginsWith("EL_EFF_TriggerEff_"));
  ...
  // Trigger Eff Syst
  if (m_eventInfoHandler.get_isMC() && isTrigEffVar) {
  ...
  if (m_eventInfoHandler.get_isMC() && isIsoVar) {
    ...
    if (m_usePLVIso) {
      Props::effSFIsoPLVLooseMediumLH.copy(inElectron, outElectron);
      Props::effSFIsoPLVLooseTightLH.copy(inElectron, outElectron);
      Props::effSFIsoPLVTightMediumLH.copy(inElectron, outElectron);
      Props::effSFIsoPLVTightTightLH.copy(inElectron, outElectron);
    }
}
...
EL::StatusCode ElectronHandler::writeNominal(xAOD::Electron* inElectron, xAOD::Electron* outElectron, const TString& /*sysName*/)
{
  ...
  if (m_usePLVIso) {
    Props::isPLVLooseIso.copy(inElectron, outElectron);
    Props::isPLVTightIso.copy(inElectron, outElectron);
  }
  //identification WPs
