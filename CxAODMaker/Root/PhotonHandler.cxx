...
//	 Props::mc_parentId.set(photon, mc_parentId);
  ...
  isLoose = photon->isAvailable<char>("DFCommonPhotonsIsEMLoose") ? static_cast<int>(photon->auxdata<char>("DFCommonPhotonsIsEMLoose")) : static_cast<bool>(m_photonLooseIsEMSelector->accept(photon));
  isMedium = photon->isAvailable<char>("DFCommonPhotonsIsEMMedium") ? static_cast<int>(photon->auxdata<char>("DFCommonPhotonsIsEMMedium")) : static_cast<bool>(m_photonMediumIsEMSelector->accept(photon));
  isTight = photon->isAvailable<char>("DFCommonPhotonsIsEMTight") ? static_cast<int>(photon->auxdata<char>("DFCommonPhotonsIsEMTight")) : static_cast<bool>(m_photonTightIsEMSelector->accept(photon));

  if(ptag>=3627) // recommendation: https://twiki.cern.ch/twiki/bin/view/AtlasProtected/EGammaRecommendationsR21
  {
    isTight = photon->isAvailable<char>("DFCommonPhotonsIsEMTightPtIncl") ? static_cast<int>(photon->auxdata<char>("DFCommonPhotonsIsEMTightPtIncl")) : static_cast<bool>(m_photonTightIsEMSelector->accept(photon));
  }
  ...
  auto isoAccept = m_isIsoPh->accept( *photon);
