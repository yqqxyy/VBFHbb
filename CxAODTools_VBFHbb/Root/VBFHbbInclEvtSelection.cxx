...
bool VBFHbbInclEvtSelection::passJetSelection(const xAOD::JetContainer* jets, const xAOD::EventInfo* evtinfo) {
...
bool VBFHbbInclEvtSelection::passTriggerSelection(const xAOD::EventInfo* evtinfo){
